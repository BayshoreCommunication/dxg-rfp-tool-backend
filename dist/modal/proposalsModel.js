...
const proposalSchema = new mongoose_1.Schema({
    ...
    proposalSettings: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    event: {
        eventName: {
            type: String,
    ...
    venueSchedule: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    roomByRoom: { type: [mongoose_1.Schema.Types.Mixed], default: [] },
    production: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    hybridVirtual: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    contentCreative: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    videoRecordingStep: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    ...
    contact: {
        ...
        additionalContacts: { type: [mongoose_1.Schema.Types.Mixed], default: [] },
