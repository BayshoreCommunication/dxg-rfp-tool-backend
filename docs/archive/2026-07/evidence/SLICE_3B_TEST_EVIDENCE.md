...
DXG completed the authenticated live-provider scenarios on July 21, 2026,
including cited extraction and drafting, ownership isolation, kill-switch and
budget enforcement, durable recovery, and the no-mutation boundary. The
superseded procedural guide was removed during the 2026-07 documentation
consolidation:
