...
export default tseslint.config(
  ...
  {
    files: ["src/**/*.ts", "contracts/**/*.ts", "config/postgres.ts", "controller/platformAssistantController.ts", "controller/historicalInsightsController.ts", "controller/requirementRegistryController.ts", "controller/evidenceExtractionController.ts", "controller/vendorIntelligenceController.ts", "controller/evaluationEngineController.ts", "controller/comparisonOrchestrationController.ts", "routes/platformAssistantRoute.ts", "routes/historicalInsightsRoute.ts", "routes/requirementRegistryRoute.ts", "routes/evidenceExtractionRoute.ts", "routes/vendorIntelligenceRoute.ts", "routes/evaluationEngineRoute.ts", "routes/comparisonOrchestrationRoute.ts", "scripts/migrateProposalV1.ts", "scripts/migrateDxgOrganization.ts", "scripts/migrateOrganizationMemberships.ts", "scripts/migratePostgres.ts", "scripts/backfillPostgresProposalReferences.ts", "scripts/backfillIdentityProjections.ts", "scripts/backfillVendorSubmissionVersions.ts", "scripts/cleanupAssistantRetention.ts", "scripts/checkAssistantReleaseReadiness.ts", "scripts/verifyAuthRefreshE2E.ts", "scripts/verifyDocumentIngestionE2E.ts", "scripts/verifyDurableJobsE2E.ts", "scripts/verifyKnowledgeIngestionE2E.ts", "scripts/verifyKnowledgeReviewE2E.ts", "scripts/verifyKnowledgeRetrievalE2E.ts", "scripts/verifyProposalContextE2E.ts", "scripts/verifyRetentionSweepE2E.ts", "scripts/platformAssistantEval.ts", "scripts/startCronWorker.ts", "scripts/startDurableWorker.ts", "scripts/startDurableDispatcher.ts", "scripts/startAiGatewayWorker.ts"],
