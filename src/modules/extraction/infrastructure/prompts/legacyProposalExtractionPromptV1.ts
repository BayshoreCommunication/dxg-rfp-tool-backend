...
Schema:
{
  ...
  "roomByRoom": {
    ...
    "recordingCodec": "one of: H.264 | H.265 | ProRes | Vendor recommendation (only if videoRecording is Yes; use Vendor recommendation only when explicitly requested)",
  ...
  "videoRecordingStep": {
    ...
    "recordingCodec": "one of: H.264 | H.265 | ProRes | Vendor recommendation (use Vendor recommendation only when explicitly requested)",
