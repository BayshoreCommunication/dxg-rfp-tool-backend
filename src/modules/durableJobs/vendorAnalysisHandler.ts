...
const SAFE_CODES=new Set(["VENDOR_EVIDENCE_EMPTY","VENDOR_RESPONSE_NOT_FOUND","PROPOSAL_NOT_FOUND","ANALYSIS_RUN_NOT_FOUND","ORGANIZATION_NOT_READY","LIVE_AI_CITATION_INVALID","LIVE_AI_OUTPUT_INVALID","LIVE_AI_INPUT_TOO_LARGE","LIVE_AI_EMPTY_OUTPUT","LIVE_AI_MALFORMED_OUTPUT","LIVE_AI_DISABLED","LIVE_AI_KILLED","LIVE_AI_CLASSIFICATION_DENIED","LIVE_AI_CREDENTIAL_UNAVAILABLE","LIVE_AI_PROVIDER_FAILED","LIVE_AI_QUOTA_EXHAUSTED"]);
