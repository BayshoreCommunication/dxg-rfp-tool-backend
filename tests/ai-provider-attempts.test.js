...
test("live provider commits a ledger attempt before invocation and reuses it as idempotency key", () => {
  ...
  assert.ok(provider.includes("idempotencyKey:attempt.fingerprint"), "fingerprint must be the provider idempotency key");
